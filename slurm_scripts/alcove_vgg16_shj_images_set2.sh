#!/bin/bash
#
#SBATCH --job-name=shj_alcove_vgg16_shj_images_set2
#SBATCH --output=/home/wv9/code/WaiKeen/alcove2/slurm_logs/shj_alcove_vgg16_shj_images_set2.out
#SBATCH --error=/home/wv9/code/WaiKeen/alcove2/slurm_logs/shj_alcove_vgg16_shj_images_set2.err
#SBATCH --time=6:00:00
