#!/bin/bash
#
#SBATCH --job-name=shj_alcove_resnet50_shj_images_set3
#SBATCH --output=/home/wv9/code/WaiKeen/alcove2/slurm_logs/shj_alcove_resnet50_shj_images_set3.out
#SBATCH --error=/home/wv9/code/WaiKeen/alcove2/slurm_logs/shj_alcove_resnet50_shj_images_set3.err
#SBATCH --time=6:00:00
