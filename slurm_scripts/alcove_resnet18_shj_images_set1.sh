#!/bin/bash
#
#SBATCH --job-name=shj_alcove_resnet18_shj_images_set1
#SBATCH --output=/home/wv9/code/WaiKeen/alcove2/slurm_logs/shj_alcove_resnet18_shj_images_set1.out
#SBATCH --error=/home/wv9/code/WaiKeen/alcove2/slurm_logs/shj_alcove_resnet18_shj_images_set1.err
#SBATCH --time=6:00:00
